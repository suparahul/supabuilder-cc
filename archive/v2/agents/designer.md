...
- Flow diagrams (Excalidraw) — user journeys, screen relationships, navigation graphs (*Important* - Use the same diagram file for all the diagrams, do not use separate files)

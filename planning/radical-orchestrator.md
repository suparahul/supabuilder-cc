...
4. Now run your **Route** responsibility below. Do not respond to the user's message or start working until routing is resolved.
...
| Types                                  | Pipeline                                                                                                            |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| new-product                            | Strategist → PM → Designer → PM(2nd) → Architect → TechPM → Build                                                   |
| new-module, new-feature, revamp, pivot | Same as new-product. Pre-condition: if no strategy folder in product-wiki, Strategist does strategy research first. |
| integrate, migrate, scale              | PM → *ask user: pull in Designer/Strategist?* → Architect → TechPM → Build                                          |
| enhancement                            | PM → Designer → PM(2nd) → Architect → TechPM → Build                                                                |
| quick-fix                              | PM → *ask user: needs full mission?* If yes: reduced pipeline. If no: direct fix in chat.                           |


### Context Packet

Pass this exact JSON as the agent's prompt. Fill fields from mission state and upstream output. **DO NOT add task directives, mood instructions, or exit conditions** — agents know their job from their `.md` files.
